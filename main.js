...
const turnoComputadora = (puntosMin) => {
    ...
    setTimeout(() => {
        ...
        alert('Nadie gana! Que loquette');
    } else if (puntosMin > 21) {
        alert('Computadoraa gana! Que pendejo');
    } else if (puntosComputadora > 21) {
        alert('GANASTEEE MAQUINOLA! Que coquette amigue');
    } else {
        alert('Computadora gana! Que pendejette');
    }
    }, 100);
...
btnPedir.addEventListener('click', function() {
    ...
    if (puntosJugador > 21) {
        console.warn('perdiste pendejette :p');
        btnPedir.disabled = true;
        btnDetener.disable = true;
        turnoComputadora(puntosJugador);
    } else if (puntosJugador === 21) {
        console.warn('21, que padre!');
